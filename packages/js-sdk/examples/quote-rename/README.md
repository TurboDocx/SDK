# Quote rename & duplicate naming — JavaScript / TypeScript example
...
npx tsx examples/quote-rename/index.ts
```
...
```bash
RUN_SEND_CHECKS=1 npx tsx examples/quote-rename/index.ts
```
