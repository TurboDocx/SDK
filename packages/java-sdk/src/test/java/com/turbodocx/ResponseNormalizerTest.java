...
class ResponseNormalizerTest {
    ...
    class BooleanCoercion {
        ...
        void handleAllBooleanFields() {
            ...
            input.addProperty("canManageUsers", 0);
            input.addProperty("canManageBilling", 1);
            input.addProperty("canViewAuditLog", 0);
            ...
            assertFalse(result.get("canManageUsers").getAsBoolean());
            assertTrue(result.get("canManageBilling").getAsBoolean());
            assertFalse(result.get("canViewAuditLog").getAsBoolean());
