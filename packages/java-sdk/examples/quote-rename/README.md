# Quote rename & duplicate naming — Java example
...
java -cp target/classes:target/dependency/* examples/quote-rename/QuoteRename.java
```
...
```bash
RUN_SEND_CHECKS=1 java -cp target/classes:target/dependency/* examples/quote-rename/QuoteRename.java
```
